    ...
    def train(self,X,y,*,epochs=1,print_every=1,validation_data=None):
        ...
        for epoch in range(1,epochs+1):
            ...
            if not epoch%print_every:
                print(" epoch: %d, acc: %.3f, loss: %.3f,data_loss: %.3f, regularized_loss: %.3f lr: %f"%(epoch, accuracy, loss,data_loss,regularization_loss, self.optimizer.current_learning_rate) )
        ...
        if validation_data is not None :
            ...
            self.predictions= self.output_layer_activation.predictions(output) 

            accuracy=self.accuracy.calculate(predictions,y_val)

            print("validation, acc:%.3f ,loss: %.3f "%(accuracy,loss))
